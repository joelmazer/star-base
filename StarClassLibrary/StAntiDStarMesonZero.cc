/***************************************************************************
 *
 * $Id: StAntiDStarMesonZero.cc,v 1.1 2010/01/28 19:31:40 jwebb Exp $
 *
 ...
 *
 **************************************************************************/
#include "StarClassLibrary/StAntiDStarMesonZero.hh" 
...
//             stable         lifetime   
//
StAntiDStarMesonZero StAntiDStarMesonZero::mAntiDStarMesonZero(
	         "D(*)0bar",      2.007*GeV,       0.0*MeV,    0.0*eplus, 
		    0,              -1,             0,          
		    1,              +1,             0,             
	      "meson",               0,             0,         -423,
