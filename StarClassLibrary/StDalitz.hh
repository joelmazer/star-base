/***************************************************************************
 *
 * $Id: StDalitz.hh,v 1.1 2010/01/28 20:01:00 jwebb Exp $
 *
...
public:
    static StDalitz* instance() {return &mDalitz;}
    static StDalitz* dalitz() {return &mDalitz;}
    
private:
    static StDalitz mDalitz;
    
    StDalitz(const string  &  aName,  
	       double           mass,     
	       double           width,
	       double           charge,   
	       int              iSpin,
