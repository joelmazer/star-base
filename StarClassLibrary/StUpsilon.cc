/***************************************************************************
 *
 * $Id: StUpsilon.cc,v 1.1 2010/01/28 19:33:20 jwebb Exp $
 *
 ...
 *
 **************************************************************************/
#include "StarClassLibrary/StUpsilon.hh" 
#include "StarClassLibrary/PhysicalConstants.h"

StUpsilon::StUpsilon(const string  &  aName,  
	       double           mass,     
	       double           width,
	       double           charge,   
	       int              iSpin,
...
//             stable         lifetime   
//
StUpsilon StUpsilon::mUpsilon
(
 "Upsilon(1S)",     9.4603*GeV,        54.02*MeV,          0., 
 2,              -1,            -1,          
 0,               0,            -1,             
 "meson",               0,             0,         553,
