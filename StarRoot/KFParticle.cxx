...
KFParticle::KFParticle( const MVertex &vertex )
{
...
Double_t KFParticle::GetDistanceFromVertexXY( const MVertex &Vtx ) const 
{
  //* Calculate distance from vertex [cm] in XY-plane
...
Double_t KFParticle::GetDeviationFromVertexXY( const MVertex &Vtx ) const 
{
  //* Calculate sqrt(Chi2/ndf) deviation from vertex
  //* v = [xyz], Cv=[Cxx,Cxy,Cyy,Cxz,Cyz,Czz]-covariance matrix
